...
- [x] **Phase 3: Publish Pipeline** - Render HTML from DB, publish to R2, permanent URLs, status lifecycle (completed 2026-03-15)
- [x] **Phase 4: Full Dashboard Types** - Buyer and buy/sell dashboard support with properties of interest (completed 2026-03-15)
- [x] **Phase 5: Gap Closure** - Fix sell data persistence, buyer navigation loop, bookkeeping & tech debt (completed 2026-03-15)
...
| 3. Publish Pipeline | 2/2 | Complete   | 2026-03-15 |
| 4. Full Dashboard Types | 2/2 | Complete   | 2026-03-15 |
| 5. Gap Closure | 1/1 | Complete   | 2026-03-15 |
